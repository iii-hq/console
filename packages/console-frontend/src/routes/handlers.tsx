        ...
        <div className="flex items-center gap-4 px-2 text-xs border-l border-border">
          ...
          <div className="flex items-center gap-1.5 text-muted">
            ...
            <span className="font-medium text-foreground tabular-nums">
              {triggers.filter((t) => !t.internal).length}
            </span>
            triggers
          </div>
        </div>
                  ...
                  {groupedFunctions[group].map((fn) => {
                    ...
                    return (
                      <div
                        ...
                        `}
                      >
                        <div className="shrink-0">{getFunctionIcon(fn)}</div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {trigger?.trigger_type === 'cron' &&
                            (() => {
                              const expr =
                                (trigger.config as { expression?: string }).expression || ''
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                          ...
                          <ChevronRight
                            className={`w-4 h-4 text-muted transition-transform ${isSelected ? 'rotate-90' : ''}`}
                          />
                        </div>
                      </div>
                    )
                        ...
                        return (
                          <>
                            ...
                            <div className="border-t border-border pt-4">
                              ...
                              {triggerResult && (
                                <div
                                  className={`mt-2 text-xs p-2 rounded ${triggerResult.success ? 'bg-success/10 text-success' : 'bg-error/10 text-error'}`}
                                >
